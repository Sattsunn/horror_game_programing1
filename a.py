...
button = sg.Button("大声で呼びかけてみる",key="a")
button2 = sg.Button("近くの民家を回ってみる",key="b")
...
def make_a_1():
    # ------------ サブウィンドウ作成 ------------
    a_layout = [ 
        [sg.Image(size=(500,500),filename="./img/town.png")],
...
def make_a_2():
    a_layout = [ [sg.Image(size=(500,500),filename="./img/town.png")],
...
def make_a_8():
    a_layout = [ [sg.Image(size=(500,500),filename="./img/car.png")],
...
def make_a_11():
    a_layout = [ [sg.Image(size=(500,500),filename="./img/house.png")],
...
def make_a_14():
    a_layout = [ [sg.Image(size=(500,500),filename="./img/forest.png")],
...
def make_a_20():
    a_layout = [ [sg.Image(size=(500,500),filename="./img/river.png")],
